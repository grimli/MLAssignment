...
cmRT
```
The result, with the D Class completly indiscovered and an accuracy of 0.59  is not particularly interesting.
...
cmBT
```
The Boosting method is more sofisticated and computationally requiring but gives better results with an accuracy of 0.985.
